import { IFRAME_METHODS, IFRAME_TYPE } from './enums';
...
export default class CrossDomainService {
    ...
    static init(iframeType: IFRAME_TYPE, options?: IFrameOptions): Promise<boolean>;
    ...
    static query<T, DATA>(method: IFRAME_METHODS, iframeType: IFRAME_TYPE, data?: DATA): Promise<T>;
    ...
    static getGlobalTCString(): Promise<string>;
    static setGlobalTCString(globalTCString: string): Promise<void>;
    /**
     * Helper method to clear the local storage on the iFrame domains
     */
    static clearCrossDomainStorage(): Promise<void>;
    static clearCookieBridgeEntries(): Promise<void>;
}
