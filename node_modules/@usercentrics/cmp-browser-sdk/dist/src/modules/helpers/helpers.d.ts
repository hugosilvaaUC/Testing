...
import { IntMap } from '@iabtcf/core';
import Settings from '../../services/Settings/models/SettingsModel';
...
export interface DataTransferSettings extends Pick<Settings, 'controllerId' | 'id' | 'version'> {
