...
import { LegacyTCF2, LegacyTCF2ChangedPurposes, ResurfaceOptions, TCFChangedPurposes } from '../../services/Settings/interfaces';
...
export declare const generateVendorsFromGVL: (tcModel: Maybe<Pick<TCModel, 'gvl' | 'publisherRestrictions' | 'vendorConsents' | 'vendorLegitimateInterests'>>, disabledSpecialFeatures: number[], useGranularChoice: boolean, hideLegitimateInterestToggles: boolean, purposeOneTreatment: boolean) => TCFVendor[];
...
export declare const getResurfaceOptions: (tcf2: Pick<LegacyTCF2, 'resurfaceIABLegalBasisChanged' | 'resurfacePeriodEnded' | 'resurfacePurposeChanged' | 'resurfaceVendorAdded'>) => ResurfaceOptions;
